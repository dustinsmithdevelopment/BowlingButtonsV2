...
export declare class HorizonProperty<T> implements ReadableHorizonProperty<T>, WritableHorizonProperty<T> {
     ...
     * You must call {@link HorizonProperty.set} to do this.
     *
...
/**
 * Creates a HorizonReferenceProperty instance.  Use this when the property is a
 * reference type that implements copy and clone methods to properly capture the
 * state of the object reference when called.
 */
...
export declare class TriggerGizmo extends Entity {
     ...
     * @param players - An array of players that can trigger the entity, or 'anyone' (default).
     *
     * @example
     * ```
     ...
     * @returns An array of players that can trigger the entity.
     *
     * @remarks
     * If the trigger is set to Objects, it will return an empty array.
     *
     * If the trigger is set to Players, it will return all players (default)
     * or the players given in {@link setWhoCanTrigger}.
     */
 ...
 * {@link AnimationCallback | animation callback} triggered, such as if the
 ...
 * @param reason - The reason why this callback has been triggered.  See {@link AnimationCallbackReason}
 */
 ...
 * @param callback - {@link AvatarGripPoseAnimationCallback} A callback that's triggered whenever an {@link AnimationCallbackReason} occurs
 */
...
export declare class Player {
    ...
    rotation: ReadableHorizonProperty<Quaternion>;
    /**
     * The root rotation of the player's avatar.
     * This is different from the normal player.rotation, which retrieves the player's head rotation.
     * When setting, only the yaw component of the input rotation will be used, keeping the character upright.
     */
     ...
     * @param options - Configuration to influence animation handling {@link PlayAvatarGripPoseAnimationOptions}.
     *
     * @example
     * ```
...
export declare abstract class Component<TComponent = ComponentWithConstructor<Record<string, unknown>>, TSerializableState extends SerializableState = SerializableState> implements DisposableObject {
    ...
    /**
     * Called when receiving a specified {@link CodeBlockEvent | code block event}
     * from a given player or entity.
     *
...
/**
 * Represents In World Player Owned Items With Item Details.
 */
export interface PlayerEntitlement {
    ...
    sku: string;
    /**
     * The number of items player owns
     */
    quantity: number;
    /**
...
/**
 * Represents fields related to the price for an In-World Purchase item.
 */
export declare type InWorldPurchasablePrice = {
    priceInCredits: number;
};
/**
 * Represents an in-world purchaseable such as an item or item pack.
 */
...
export declare class WorldInventory {
    /**
     * Fetches a list of active entitlements for specific player within a world.
     * @param player - The player to fetch in world entitlements for
     * @returns - A promise that resolves to a list of in world entitlement details for the player
     *
     */
    static getPlayerEntitlements(player: Player): Promise<PlayerEntitlement[]>;
    /**
     * Accepts a list of SKUs and returns a list of this world's in-world Purchasable with SKUs
     * that match the list of SKUs provided.
     *
     * @param skus - A list of item SKUs to query for
     * @returns - A  list of in-world Purchasable with SKUs that match the list of SKUs provided
     * @example
     * ```
     * const arrowPurchasable = await WorldInventory.getWorldPurchasableBySKUs(["arrow_sku"]);
     * ```
     */
    static getWorldPurchasablesBySKUs(skus: Array<string>): Promise<Array<InWorldPurchasable>>;
    /**
     * Does the player have an entitlement for the in-world item for the SKU.
     *
     * @param player - The player to fetch in world entitlements for
     * @param sku - Item/Item Pack SKUs to verify entitlement for
     * @returns - Returns true if the player owns the in-world item for the SKU, otherwise false.
     *
     */
...
/**
 * InWorldPurchase contains APIs for the purchasing in-world items
 */
export declare class InWorldPurchase {
    /**
     * Launches the checkout for the in-world item for the given player
     *
     * @param player - The player purchasing the item
     * @param sku - The SKU of the in-world item being purchased
     */
